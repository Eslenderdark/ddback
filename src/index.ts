    ...
    try {
        ...
        if (rand < 0.7) {
            ...
            if (pocoComunesRestantes.length > 0) {
                const idx = Math.floor(randGen() * pocoComunesRestantes.length);
